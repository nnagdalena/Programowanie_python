...
class Library:
  ...
  def __init__ (self, city: str, street: str, zip_code: int, open_hours: str, phone: int) -> None:
    self.city = city
    self.street = street
...
e1 = Employee('Madzia', 'Bogacz', date(1960, 10, 1), date(2020, 1, 1), 'Sosnowiec', 'ul. Kochanowskiego', '40-098', '123456789')
e2 = Employee('Madzia', 'Kulczyk', date(1960, 10, 2), date(2021, 1, 1), 'Bytom', 'ul. Matejki', '40-099', '111111111')
e3 = Employee('Madzia', 'Bezos', date(1960, 10, 3), date(2019, 1, 1), 'Będzin', 'ul. Przemka z Hotelu Paradise', '40-097', '222222')
